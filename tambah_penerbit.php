                  ...
                  <div class="full">
                     ...
                     <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                        ...
                        <div class="container" style="margin-top: 105px;">
                           <h3 class="font-weight-bold text-white d-flex justify-content-center">Tambah Daftar Penerbit</h3>
                           <form action="" method="POST">
                              <div class="form-group">
                                 <label for="id_penerbit" class="text-white">Id Penerbit</label>
                                 <input type="text" class="form-control" id="id_penerbit" name="id_penerbit" placeholder="Id penerbit">
                              </div>
                              <div class="form-group">
