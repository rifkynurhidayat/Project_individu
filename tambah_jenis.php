                           ...
                           <h3 class="font-weight bold text-white d-flex justify-content-center">Input jenis buku</h3>
                              <form action="" method="POST">
                                 <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control mb-4" name="id_jenis_buku" id="d_jenis_buku" aria-describedby="id jenis buku..">
                                 </div>
                                 <div class="mb-3">
                                    <label for="jenis_buku" class="form-label text-white">Jenis Buku</label>
                                    <input type="text" class="form-control mb-4" name="jenis_buku" id="jenis_buku">
                                 </div>
