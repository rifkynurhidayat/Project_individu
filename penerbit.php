         ...
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="container" style="margin-top: 80px;">
                  <h3 class="font-weight-bold text-white d-flex justify-content-center">Daftar Penerbit</h3>
                  <a class="btn btn-info mb-4"   href="tambah_penerbit.php">Tambah Penerbit</a>
                     <table class="display " id="myTable">
                        <thead>
                              <tr>
                                 <th class="text-white">Nomor</th>
                                 <th class="text-white">Id Penerbit</th>   
                                 <th class="text-white">Nama Penerbit</th>
                           ...
                           <tr>
                                 ...
                                 <?php foreach($penerbit as $penerbits) : ?>
                                    <td><?= $i; ?></td>
                                    <td><?= $penerbits["id_penerbit"];?></td>
                                    <td><?= $penerbits["nama_penerbit"]; ?></td>
                                    <td><?= $penerbits["email"]; ?></td>
                                    <td><?= $penerbits["alamat"]; ?></td>
                                    <td>
                                       <a class="btn btn-primary" href="editPenerbit.php?id_penerbit=<?= $penerbits['id_penerbit'];?>">Edit</a>
                                       <a class="btn btn-danger" href="hapusPenerbit.php?id_penerbit=<?= $penerbits['id_penerbit'];?>" onclick=" return confirm('Yakin akan dihapus?');" >Hapus</a>
                                    </td>
                           </tr>
                                 <?php $i++; ?>
                                 <?php endforeach; ?>
